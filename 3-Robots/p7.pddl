...
(:objects
    ...
    explorer_1 explorer_2 explorer_3 - robot_explorer
...
(:init
    ...
    (robot_explorer_at explorer_2 wp1)
    (robot_explorer_at explorer_3 wp5)
    (undocked_explorer explorer_1)
    (undocked_explorer explorer_2)
    (undocked_explorer explorer_3)
    (camera_free camera)
    (scan_sensor_free scan)
    (available explorer_1)
    (available explorer_2)
    (available explorer_3)
    (robot_capable explorer_1)
    (robot_capable explorer_2)
    (= (consumption_rate_explorer explorer_1) 1.5)
    (= (consumption_rate_explorer explorer_2) 1.5)
    (= (consumption_rate_explorer explorer_3) 1.5)
    (= (distance wp0 wp0) 0)
    (= (distance wp0 wp1) 6)
    ...
    (= (energy_capacity_explorer explorer_2) 100)
    (= (energy_capacity_explorer explorer_3) 100)
    (= (energy_explorer explorer_1) 100)
    (= (energy_explorer explorer_2) 100)
    (= (energy_explorer explorer_3) 100)
    (= (image_data explorer_1) 0)
    (= (image_data explorer_2) 0)
    (= (image_data explorer_3) 0)
    (= (image_data_capacity explorer_1) 40)
    (= (image_data_capacity explorer_2) 40)
    (= (image_data_capacity explorer_3) 40)
    ...
    (= (sample_data explorer_2) 0)
    (= (sample_data explorer_3) 0)
    (= (sample_data_capacity explorer_1) 20)
    (= (sample_data_capacity explorer_2) 20)
    (= (sample_data_capacity explorer_3) 20)
    (= (total-distance) 0)
)
; =============================================================================================
